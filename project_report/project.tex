...
This will be helpful to finding the best website among list of
websites.
...
\begin{itemize}
	...
	\item[5.] If count == 0 then give rank as 0.
	\item[6.] else if count is greater than or equal to 5, then also give rank as 0.
